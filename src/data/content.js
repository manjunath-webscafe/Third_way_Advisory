...
export const verticals = [
    ...
    items: [
      {
        ...
        body: "Capital raising, debt restructuring, and cash flow optimization.",
      },
      {
        title: "Project Finance",
        body: "Structuring viable funding models for large-scale infrastructure.",
      },
      {
        title: "Risk Assessment",
        body: "Identifying market vulnerabilities to safeguard asset growth.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        body: "Connecting your business with key industry decision-makers.",
      },
      {
        title: "Consensus Building",
        body: "Resolving complex multi-party bottlenecks efficiently.",
      },
      {
        title: "Alliance Management",
        body: "Fostering long-term public and private partnerships.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    tagline:
      "Executing High-Value Deals, Asset Resolutions & Real Estate Transactions",
    ...
    items: [
      ...
      {
        title: "M&A Advisory",
        body: "Identifying target companies and strategic real estate assets that offer maximum synergistic value.",
      },
      {
        title: "Due Diligence",
    ...
    items: [
      {
        ...
        body: "Global networks providing deep liquidity pools.",
      },
      {
        title: "Legal Consuls",
        body: "Top-tier firms ensuring bulletproof transaction legalities.",
      },
      {
        title: "Tech Innovators",
        body: "Pioneers enhancing our analytical and data capabilities.",
      },
    ],
  },
  clients: {
    ...
    items: [
      {
        title: "Conglomerates",
        body: "Streamlining multi-national regulatory compliance.",
      },
      {
        title: "Private Equity",
        body: "Assisting funds in identifying lucrative acquisition targets.",
      },
      {
        title: "Mid-Market Firms",
        body: "Accelerating the transition into institutional-grade enterprises.",
      },
    ],
  },
};
      ...
      items: [
        {
          type: "Whitepaper",
          title:
            "Navigating Urban Transitions: Structural Shifts in BDA & BBMP Compliance.",
        },
        {
          type: "Article",
          title:
            "A Checklist for Seamless KRERA Quarterly Filings and Extension Submissions.",
        },
      ],
    },
    {
      ...
      items: [
        {
          type: "Whitepaper",
          title:
            "Optimising Capital Structures for Infrastructure Scaling in Emerging Markets.",
        },
        {
          type: "Article",
          title:
            "Evaluating Synergy: Best Practices in Modern Corporate Due Diligence.",
        },
      ],
    },
    {
      ...
      items: [
        {
          type: "Whitepaper",
          title:
            "Navigating Corporate Debt Resolution: Strategic Interventions with ARCs and Banks.",
        },
      ],
    },
    {
      ...
      items: [
        {
          type: "Whitepaper",
          title:
            "The Anatomy of a Bulletproof JDA: Protecting Landowner Equity and Builder Viability.",
        },
      ],
    },
  ],
